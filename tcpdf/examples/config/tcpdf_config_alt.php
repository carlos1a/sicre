 ...
 */
define ('PDF_HEADER_LOGO', 'logofp.gif');

/**
 * Header logo image width in user units.
 */
define ('PDF_HEADER_LOGO_WIDTH', 30);
define ('PDF_FOOTER_STRING', 'HOLA');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Gerencia de Tecnología');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Farmapatria CA \nActa de Entrega de Activos Tecnológicos");
